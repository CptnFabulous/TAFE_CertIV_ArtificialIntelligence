...
Shader "Hidden/EdgeDetect-PostProcess"
{
	HLSLINCLUDE
		...
		#include "PostProcessing/Shaders/StdLib.hlsl" // I have no idea what this file does but apparently it fixes some problem, there was originally the line of code above us which is commented out because it apparently causes problems
